...
function updatePet() {
    ...
    // Datos antiguos
    var dataTS = document.getElementById('dataTS').value;
    ...
    const loaderURL = "/php/adm_updatePet.php";
...
var dataTSInput = document.getElementById('dataTS');
...
let old_dataTS = dataTSInput.value; //Select
...
dataTSInput.addEventListener('change', checkInputChange);
...
function checkInputChange() {
    ...
    const new_dataTS = dataTSInput.value; //Select
