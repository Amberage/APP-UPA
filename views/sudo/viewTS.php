...
<head>
    ...
    <title>SU | Administrar Trabajadores</title>
</head>
...
<body>
    ...
    <div class="banner__content">
      ...
      <div class="banner__card">
        <h4 id="lbl-total">0</h4>
        <div><p>trabajadores</label></div>
        <div><p>encontrados</label></div>
      </div>
    </div>
    </section>
    ...
    <script src="/javascript/sudo_viewTS.js"></script>
