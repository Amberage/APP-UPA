                ...
                <form method="POST" autocomplete="off">
                    <div class="twoColumns">
                        ...
                        <div class="petData">
                            ...
                            <div class="inputbox">
                                <input type="file" name="petPicture" id="petPicture" required/>
                                <label>Foto</label>
                            </div>
                        </div>
                    ...
                    <div><button class="login" onclick="return validarComboBox()">Registrar Mascota</button></div>
                </form>
            </div>
        </div>
    </section>
